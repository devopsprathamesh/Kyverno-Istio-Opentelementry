...
# auto-setup-default-kube-env during Phase 2, and a related unguarded-
# pipeline variant found and fixed in istio/tests/static-validation.sh
# during Phase 4 (see root docs/VALIDATION-STATUS.md for both stories).
set -euo pipefail
